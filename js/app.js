...
for (let index = 0; index < tabs.length; index++) {
	...
	for (let index = 0; index < tabs_items.length; index++) {
		...
		tabs_item.addEventListener("click", function (e) {
			for (let index = 0; index < tabs_items.length; index++) {
				let tabs_item = tabs_items[index];
				tabs_item.classList.remove('_actives');
				tabs_blocks[index].classList.remove('_actives');
			}
			tabs_item.classList.add('_actives');
			tabs_blocks[index].classList.add('_actives');
			e.preventDefault();
		});
	}
}
...
if (document.querySelector('.slider-autopark__body')) {
	new Swiper('.slider-autopark__body', {
		observer: true,
		observeParents: true,
		slidesPerView: 3,
		spaceBetween: 32,
		...
		// Dotts
		pagination: {
			el: '.slider-autopark__dotts',
			clickable: true,
		},
		// Arrows
		navigation: {
			nextEl: '.slider-autopark .slider-arrow_next',
			prevEl: '.slider-autopark .slider-arrow_prev',
		},
		breakpoints: {
...
if (document.querySelector('.slider-review__body')) {
	new Swiper('.slider-review__body', {
		...
		// Dotts
		pagination: {
			el: '.slider-review__dotts',
			clickable: true,
		},
		// Arrows
		navigation: {
			nextEl: '.slider-review .slider-arrow_next',
			prevEl: '.slider-review .slider-arrow_prev',
		},
		breakpoints: {
			// when window width is >= 320px
			320: {
...
if (document.querySelector('.slider-articles__body')) {
	new Swiper('.slider-articles__body', {
		...
		// Arrows
		navigation: {
			nextEl: '.slider-articles .slider-arrow_next',
			prevEl: '.slider-articles .slider-arrow_prev',
		},
		breakpoints: {
			// when window width is >= 320px
			320: {
